...
namespace hw11 {
    ...
    bool ascending(int x, int y)
    {
        ...
        if (x > y) return x > y; // if the first element is greater than the second
    ...
    bool descending(int x, int y)
    {
        ...
        if (x < y) return x < y; // swap if the second element is greater than the first
...
int main()
{
    ...
    //fcnPtr1 = &boo;// wrong -- return types don't match! // [1.4] assign fcnPtr1 to point to boo
...
// This has been set to D2::function1(). Therefore, dPtr->function1() resolves to D2::function1()
//

// Q#5

// We cannot assign a base class object to a derived class because inheritance is an "is-a" 
// relationship, but it's one-way only. Slicing problem is that we assign an object of type 
// Derived to a variable of type Base. To fix this problem, use pointers to dynamic variables.
// However, a derived class object can be assigned to a base class object
